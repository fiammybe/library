...
class mod_library_PublicationHandler extends icms_ipf_Handler
{
    ...
    public function getFormatOptions()
    {
        ...
        $criteria = new icms_db_criteria_Compo(
            new icms_db_criteria_Item('dirname', '%' . basename(dirname(__FILE__, 2)) . '%', 'LIKE')
        );
    ...
    {
        return [
            0 => _CO_LIBRARY_PUBLICATION_FEDERATION_DISABLED,
    ...
    protected function clear_cache(&$obj)
    {
        ...
        if ($cache_status[$module_id] > 0) {
            ...
            try {
                ...
                exec(
                    "find " . ICMS_CACHE_PATH . "/" . "library^%2Fmodules%2Flibrary%2Fpublication.php%3Fstart* -delete &"
                );
                exec(
                    "find " . ICMS_CACHE_PATH . "/" . "library^%2Fmodules%2Flibrary%2Fpublication.php%3Ftag_id* -delete &"
                );
                ...
                if (!$obj->isNew()) {
                    exec(
                        "find " . ICMS_CACHE_PATH . "/" . "library^%2Fmodules%2Flibrary%2Fpublication.php%3Fpublication_id%3D"
